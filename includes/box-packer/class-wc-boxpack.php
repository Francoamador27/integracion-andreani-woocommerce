...
class ANDREANI_Boxpack {
	...
	public function add_item( $length, $width, $height, $weight, $value = '', $meta = array() ) {
		...
		$this->items[] = new ANDREANI_Boxpack_Item( $length, $width, $height, $weight, $value, $meta );
	...
	public function add_box( $length, $width, $height, $weight = 0 ) {
		...
		$new_box = new ANDREANI_Boxpack_Box( $length, $width, $height, $weight );
