<tr valign="top" id="packing_options">
	<th scope="row" class="titledesc"><?php _e( 'Contrato para envíos', 'wc_wanderlust' ); ?></th>
	<td class="forminp">
		<style type="text/css">
		...
		<script type="text/javascript">
 			...
 			jQuery(document).ready(function () {
				...
				jQuery('#woocommerce_andreani_wanderlust_origin').change(function(){
					  ...
					  var api_user = jQuery('#woocommerce_andreani_wanderlust_api_user').val();
					  var api_password = jQuery('#woocommerce_andreani_wanderlust_api_password').val();
					  var api_nrocuenta = jQuery('#woocommerce_andreani_wanderlust_api_nrocuenta').val();
					  var prod = 'prod';					
